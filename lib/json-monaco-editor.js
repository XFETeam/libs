...
var JsonMonacoEditor = function JsonMonacoEditor(_ref) {
  var onChange = _ref.onChange,
      ...
      uid = _ref.uid,
      restProps = _objectWithoutProperties(_ref, ["onChange", "options", "reloadInitialCode", "uid"]);

  var _useState = (0, _react.useState)(null),
      _useState2 = _slicedToArray(_useState, 2),
      stateProps = _useState2[0],
      setStateProps = _useState2[1];

  var editor;
  var api;
  var handleChange = (0, _react.useCallback)(function (newCode) {
    if (api) {
  ...
  (0, _react.useEffect)(function () {
    ...
    api.onLoad();
    return api.addOnLoadReceivedListener(function (data) {
      setStateProps(data);
    });
  }, []);
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactMonacoEditor["default"], _extends({
    height: "100vh",
    width: "10vw",
    theme: "vs",
    language: "json"
