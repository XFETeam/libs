 ...
 * @return {*}
 */
export default function initTracker(createTracker, config, thirdPartyAuthStore, debug) {
  const { stReportSdk, getDiffRouteTime, report } = getReport(config, thirdPartyAuthStore, debug);
